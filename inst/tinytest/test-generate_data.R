...
# generate_lmm_data returns correct dimensions
...
# create_scenario_grid produces correct grid size
...
# create_scenario_grid seeds are unique
grid <- create_scenario_grid(n_sim = 10)
